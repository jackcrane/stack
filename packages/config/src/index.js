...
export const parseBaseConfig = (env) => baseSchema.parse(env);

export const parseWebConfig = (env) => webSchema.parse(env);

export const parseApiConfig = (env) => apiSchema.parse(env);
